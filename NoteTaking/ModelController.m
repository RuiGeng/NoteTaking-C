...
- (NSUInteger)indexOfViewController:(DataViewController *)viewController {
    ...
    Person *classSpecifiedInstance = (Person *)viewController.dataObject;
    if(classSpecifiedInstance != nil){
        //Person Name
        if(classSpecifiedInstance.name != nil){
            NSLog(@"name = %@", classSpecifiedInstance.name);
        }
        if(classSpecifiedInstance.timestamp != nil){
            NSLog(@"timestamp = %@", classSpecifiedInstance.timestamp);
        }
        if(classSpecifiedInstance.interaction != nil){
            NSLog(@"interaction = %@", classSpecifiedInstance.interaction);
        }
    }
